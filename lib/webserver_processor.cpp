...
String processor(const String& var){
     ...
     */else if (var == "DATASERIALCHECK"){
        ...
        return str2HTML;
          ...
          str2HTML = String(config.AP_Passwd);
          return str2HTML; 
     }else if (var == "SLEEPTIME"){
          str2HTML = String(config.Sleep_mins);
          return str2HTML; 
     }else if (var == "TOUCHTHRESHOLD"){
          str2HTML = String(config.Touch_Threshold);
          return str2HTML;
          ...
          str2HTML = String(config.intTargetReached);
          return str2HTML;
